		...
		<section>
			<div class="navbar navbar-default navbar-static-top col-md-12 col-sm-12 col-xm-12">
				...
				<div class="navbar-header">
					<a class="navbar-brand " href="#"><h2>Doctor</h2></a>
				</div>
		...
		<div class="innerdiv"> 
				<div class="panel panel-default sidebar">
					...
					<ul class="list-group ">
							...
							<li><a class="list-group-item item menu_color" href="patients"><span class="glyphicon glyphicon-user"></span> Patients</a></li>																																							
							<li><a class="list-group-item item menu_color" href="notice"><span class="glyphicon glyphicon-edit"></span> Notice Board </a></li>

							<li><a class="list-group-item item menu_color" href="profile"><span class="glyphicon glyphicon-pencil"></span> My profile</a></li>
